...
1. استخرج الأرقام الحقيقية المكتوبة في المستند فقط (المبلغ الإجمالي total_amount، المجموع قبل الضريبة والخدمة subtotal، بدل أو رسوم الخدمة service_charge في المطاعم والكافيهات إن وجدت، قيمة الضريبة tax_amount).
2. في فواتير المطاعم والمقاهي (Guest Check / Table Check)، ابحث دائماً عن بدل أو رسوم الخدمة (Service Charge / Service %) وضع قيمته في حقل "service_charge" (المعادلة: الإجمالي = المجموع + الخدمة + الضريبة - الخصم).
3. إذا كان المستند مبيعات كاشير أو فاتورة طاولة زبون، استخرج تفاصيل الدفع المقبوضة (كاش، بطاقات POS، كليك CliQ، تطبيقات توصيل).
